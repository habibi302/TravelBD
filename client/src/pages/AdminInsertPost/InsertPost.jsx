      ...
      <h1 className='text-center'>New Post</h1>
        <Form>
          ...
          <Form.Group className='mb-3'>
            ...
            <Form.Control id='where_to_eat' as="textarea" rows="3" ref={whereToEat}/>
            {errors?<span className='help-block text-danger'>{errors.whereToEat}</span>:""}
          </Form.Group>
          <Form.Group className='mb-3'>
            <Form.Label htmlFor='some_places'>Some Places</Form.Label>
            <Form.Control id='some_places' as="textarea" rows="3" ref={somePlaces}/>
            {errors?<span className='help-block text-danger'>{errors.somePlaces}</span>:""}
          </Form.Group>
          <Button variant='dark' className='w-100' onClick={handleSubmit}>Insert</Button>
        </Form>
      </Container>
    </>
  )
